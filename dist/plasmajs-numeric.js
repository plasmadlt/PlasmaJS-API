...
function stringToPublicKey(s) {
    ...
    if (s.substr(0, 6) === "PLASMA") {
        var whole = base58ToBinary(exports.publicKeyDataSize + 4, s.substr(6));
...
/** If a key is in the legacy format (`PLASMA` prefix), then convert it to the new format (`PUB_K1_`).
...
//# sourceMappingURL=plasmajs-numeric.js.map