...
describe("plasmajs-api", () => {
    ...
    it("getAbi returns an abi", async () => {
        const response = await api.getAbi("testplasmatoken");
    ...
    it("getContract returns a contract", async () => {
        const response = await api.getContract("testplasmatoken");
